...
public class Utils {
    ...
    //TODO 请填写您生成的一个token
    public static final String USER_TOKEN_1 = ;
    //USER_TOKEN_1 对应的userId
    public static final String USER_ID_1 =

    //TODO 请填写您生成的不同于 token1 的一个token;
    public static final String USER_TOKEN_2 =
    public static final String USER_ID_2 =
