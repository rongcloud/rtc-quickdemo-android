...
//        videoConfig.setBackgroundColor(255,0,0);
     ...
     * @return
     */
    private RCRTCMixConfig.CustomLayoutList.CustomLayout twoPeople(RCRTCMixConfig.CustomLayoutList.CustomLayout videoLayout,int i,int width,int height){
    ...
    private RCRTCMixConfig.CustomLayoutList.CustomLayout threePeople(RCRTCMixConfig.CustomLayoutList.CustomLayout videoLayout,int i,int videoWidth,int videoHeight){
    ...
    private RCRTCMixConfig.CustomLayoutList.CustomLayout fourPeople(RCRTCMixConfig.CustomLayoutList.CustomLayout videoLayout,int i,int videoWidth,int videoHeight){
