...
public abstract class CallkitBaseActivity extends Base {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        linearLayout=findViewById(cn.rongcloud.common.R.id.line1);
        btn_login1=findViewById(cn.rongcloud.common.R.id.btn_login1);
        btn_login2=findViewById(cn.rongcloud.common.R.id.btn_login2);
    }
    ...
    public  void callkitloginClick(View view){
        int id = view.getId();
        if (id == cn.rongcloud.common.R.id.btn_login1) {
            connectIM(Utils.USER_TOKEN_1);
            btn_login2.setVisibility(View.INVISIBLE);
        } else if (id == cn.rongcloud.common.R.id.btn_login2) {
